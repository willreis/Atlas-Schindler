          ...
          <div className="row">
            <div className="col-md-6 col-sm-12">
              <div className="tituloInterno">
                <h2 className="titulosPrincipais" Style="padding-left: 0!important">Lançar Saída Gôndola</h2>
              </div>
            </div>
          </div>

          <div className="row mt-5">
            <form className="tabelaMovimentoSaida">
              <div class="row">
                <div className="col-md-3">
                  <label for="numGondola">Número da Gôndola</label>
                  <input id="numGondola" type="number" class="form-control" />
                </div>
                <div className="col-md-3">
                  <label for="codMaterial">Código do Material</label>
                  <input id="codMaterial" type="number" class="form-control" />
                </div>
                <div className="col-md-3 boxBtn">
