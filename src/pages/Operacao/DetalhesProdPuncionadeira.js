                ...
                setGetProducao(
                    response.data.map((producao) => {
                        return {
                            ...
                            vg: producao.vg,
                            mensagemDePriorizacao: response.mensagemDePriorizacao,
                            avisoDoAdministrador: response.avisoDoAdministrador,
                            ordensCustomizadas: response.ordensCustomizadas,
                            ordensKanban: response.ordensKanban
                        }
                    }))
            })
            .catch((error) => {
