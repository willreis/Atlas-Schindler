...
function Alarmes() {
    ...
    const columns = [
        {
            dataField: "codigoDoAlarme",
            text: "Código do Alarme",
            headerAlign: "center",
            headerStyle: { backgroundColor: "rgb(151 151 151)", fontSize: "14px" },
            sort: true,
            filter: textFilter({
                placeholder: "Filtrar Código do Alarme",
            }),
        },
        {
            dataField: "alarme",
        ...
        {
            dataField: "reconhecido",
            text: "Reconhecido",
            headerAlign: "center",
            headerStyle: { backgroundColor: "rgb(151 151 151)", fontSize: "14px" },
            sort: true,
            filter: textFilter({
                placeholder: "Filtrar Reconhecido...",
            }),
        },
        {
            dataField: "opcoes",
                    ...
                    <div className="row">
                        <div className="col-md-6 col-sm-12">
                            <div className="tituloInterno">
                                <h2 className="titulosPrincipais">Alarmes</h2>
                            </div>
                        </div>
                    </div>
